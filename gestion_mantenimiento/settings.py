...
if os.environ.get('RAILWAY_ENVIRONMENT'):
    railway_hosts = [
        'web-production-f2af9.up.railway.app',  # Tu dominio actual
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'gestion_mantenimiento.solicitudes.context_processors.is_admin',
            ],
        },
    },
]
...
STATICFILES_STORAGE = 'django.contrib.staticfiles.storage.StaticFilesStorage'  # Temporalmente sin manifest
